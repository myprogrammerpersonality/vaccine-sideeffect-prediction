...
logging.basicConfig(filename='logs/T1.log', format="%(asctime)s - %(levelname)s - %(message)s", level=logging.INFO)
...
data[dose_1_columns].describe().to_csv(f'{output_path}/reports/{vaccine_type}_Report_Dose1_{time.strftime("%Y-%m-%d")}.csv')
data.drop(dose_1_columns_full, axis=1).describe().to_csv(f'{output_path}/reports/{vaccine_type}_Report_Features_{time.strftime("%Y-%m-%d")}.csv')
...
results_df.to_csv(f'{output_path}/results/D1_Logistic_Regression_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.title(f'Dose 1 Logistic Regression {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D1_Logistic_Regression_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D1_SVM_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
plt.style.use('fivethirtyeight')
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 1 SVM {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D1_SVM_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D1_XGBClassifier_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 1 XGBClassifier {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D1_XGBClassifier_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D1_RF_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 1 RF {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D1_RF_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D1_MLP_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 1 MLP {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D1_MLP_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D1_KNN_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 1 KNN {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D1_KNN_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
