...
logging.basicConfig(filename='logs/T5.log', format="%(asctime)s - %(levelname)s - %(message)s", level=logging.INFO)
...
data[dose_last_columns_full].describe().to_csv(f'{output_path}/reports/D2-1_{vaccine_type}_Report_{time.strftime("%Y-%m-%d")}.csv')
data.drop(dose_last_columns_full, axis=1).describe().to_csv(f'{output_path}/reports/D2-1_{vaccine_type}_Report_Features_{time.strftime("%Y-%m-%d")}.csv')
...
data = data.drop(dose_1_columns_full, axis=1)
...
for index, target in enumerate(dose_last_columns):
    ...
    results_df.loc[index] = [target, auc_mean, auc_std, acc_mean, acc_std, grid.best_params_,
                            best_result.mean_train_roc_auc.item(), best_result.std_train_roc_auc.item(), best_result.mean_test_roc_auc.item(),  best_result.std_test_roc_auc.item(), auc_test,
                            best_result.mean_train_accuracy.item(), best_result.std_train_accuracy.item(), best_result.mean_test_accuracy.item(),  best_result.std_test_accuracy.item(), accuracy_test,
                            best_result.mean_train_precision.item(), best_result.std_train_precision.item(), best_result.mean_test_precision.item(),  best_result.std_test_precision.item(), precision_test,
                            best_result.mean_train_recall.item(), best_result.std_train_recall.item(), best_result.mean_test_recall.item(),  best_result.std_test_recall.item(), recall_test,
                            ]

results_df.to_csv(f'{output_path}/results/D2-1_Logistic_Regression_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.title(f'Dose 2 without Dose 1 data Logistic Regression {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D2-1_Logistic_Regression_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D2-1_SVM_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
plt.style.use('fivethirtyeight')
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 2 without Dose 1 data SVM {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D2-1_SVM_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D2-1_XGBClassifier_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 2 without Dose 1 data XGBClassifier {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D2-1_XGBClassifier_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D2-1_RF_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 2 without Dose 1 data RF {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D2-1_RF_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D2-1_MLP_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 2 without Dose 1 data MLP {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D2-1_MLP_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
...
results_df.to_csv(f'{output_path}/results/D2-1_KNN_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.csv', index=False)
...
plt.ylabel('Performance on 5-Fold Cross Validation')
plt.title(f'Dose 2 without Dose 1 data KNN {name_dict[vaccine_type]}')

fig.savefig(f'{output_path}/image/D2-1_KNN_{vaccine_type}_CVTest_{time.strftime("%Y-%m-%d")}.png', bbox_inches='tight')
